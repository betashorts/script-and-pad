...
og: >
  title: "Screenplay Format: The Complete Guide to Formatting Your Script"
  description: "The five formatting elements every screenplay uses, the margin rules, what to cut from a spec script, and tools that handle formatting automatically as you write."
  url: "https://scriptandpad.com/screenplay-format-guide/"
  type: "article"
...
If you're working from an existing script and need to break it down into shots, the [shot list generator](/shot-list/) parses your INT. and EXT. sluglines automatically and organises them into a production-ready hierarchy.
...
For a deeper understanding of what each element communicates, read [what is a screenplay](/what-is-a-screenplay/) before you start applying these rules.

<hr>
<p><strong>Ready to format your screenplay?</strong><br>
Screenplay Writer is a Google Docs add-on that handles all the formatting rules in this guide automatically — scene headings, action lines, character names, dialogue, and parentheticals, all properly positioned as you type. 21-day free trial.<br>
