...
og: >
  title: "Music Video Screenplay: How to Write a Script for Your Music Video"
  description: "The difference between a music video treatment and a shooting script, how to structure verse and chorus blocks, and how to notate lyric cues — everything you need before you press record."
  url: "https://scriptandpad.com/music-video-screenplay/"
  type: "article"
...
Examples:
- `At 0:47 (CHORUS) — "I was never yours" — Diana steps forward into light`
- `At 1:32 (DROP) — instrumental — Cut to wide: entire band, silhouette`
- `At 2:14 (BRIDGE) — "burning" — Slow push into her eyes`
...
That said, clear structure and consistent formatting make the document easier to use on set. Once you have your script, building a [shot list](/shot-list/) is a natural next step — especially for a narrative or performance video where specific shots need to be planned in advance.

For guidance on standard screenplay formatting rules, read [screenplay format: the complete guide](/screenplay-format-guide/).

<hr>
<p><strong>Ready to write your music video script?</strong><br>
Screenplay Writer is a Google Docs add-on that automatically formats scene headings, action lines, and all standard screenplay elements as you type — useful for structuring music video scripts and short film screenplays alike. 21-day free trial.<br>
